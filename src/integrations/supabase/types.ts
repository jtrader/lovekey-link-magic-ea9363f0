  ...
  public: {
    Tables: {
      ...
      rsp_permissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "rsp_permissions_family_id_fkey";
            columns: ["family_id"];
            isOneToOne: false;
            referencedRelation: "families";
            referencedColumns: ["id"];
      ...
      trusted_contacts: {
        Row: {
          ...
          can_receive_support_requests: boolean;
          created_at: string;
          updated_at: string;
        };
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "trusted_contacts_family_id_fkey";
            columns: ["family_id"];
            isOneToOne: false;
            referencedRelation: "families";
            referencedColumns: ["id"];
      ...
      support_requests: {
        Row: {
          ...
          routed_to_contact_id: string | null;
          created_at: string;
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "support_requests_routed_to_contact_id_fkey";
            columns: ["routed_to_contact_id"];
            isOneToOne: false;
