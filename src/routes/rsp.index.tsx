    ...
    <>
      ...
      <section className="rsp-section" id="pulse">
        <div className="rsp-section-header">
          ...
          <h2 className="rsp-h2">Global Population Pulse & Resource Allocation</h2>
          <p className="rsp-lead">
            Measuring real-time capacity, strain, and resource demand across populations without human surveillance.
          </p>
        </div>
        ...
        >
          <a href="#pulse-spec" className="rsp-principle-card" style={{ textDecoration: "none" }}>
            <div className="rsp-pc-icon"><IconShield /></div>
            <div className="rsp-pc-title" style={{ color: "var(--rsp-primary)" }}>Open Specification →</div>
            <div className="rsp-pc-body">Protocol invariants for edge telemetry, burn-on-write, and k-anonymity thresholding.</div>
          </a>
          <a href="#pulse-strain" className="rsp-principle-card" style={{ textDecoration: "none" }}>
            <div className="rsp-pc-icon"><IconScale /></div>
            <div className="rsp-pc-title" style={{ color: "var(--rsp-primary)" }}>Strain Engine (ESI) →</div>
            <div className="rsp-pc-body">The Event Strain Index mathematical formulation for real-time capacity vs demand sensing.</div>
          </a>
          <a href="#pulse-disaster-aid" className="rsp-principle-card" style={{ textDecoration: "none" }}>
            <div className="rsp-pc-icon"><IconHeart /></div>
            <div className="rsp-pc-title" style={{ color: "var(--rsp-primary)" }}>Disaster Aid Framework →</div>
            <div className="rsp-pc-body">Integration across Crisis Compass, AidAngel, Guardian Guide, and FirstAidAngel.</div>
          </a>
        </div>
      </section>

      {/* RSP PULSE SPECIFICATION */}
      <section
        className="rsp-section"
        id="pulse-spec"
        style={{
          background: "var(--rsp-bg-warm)",
          borderTop: "1px solid var(--rsp-border)",
          borderBottom: "1px solid var(--rsp-border)",
        }}
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="rsp-section-header">
            <div className="rsp-eyebrow">Technical Standard</div>
            <h2 className="rsp-h2">@rsp/pulse v1.0 Open Specification</h2>
            <p className="rsp-lead">
              Macro population strain sensing architecture designed for emergency responders, municipal infrastructure, and global aid networks.
            </p>
          </div>

          <div className="rsp-principle-grid">
            <div className="rsp-principle-card">
              <div className="rsp-pc-icon"><IconEye /></div>
              <div className="rsp-pc-title">1. Edge Intent Translation</div>
              <div className="rsp-pc-body">Edge actions from 100+ countries across 50+ languages are normalized into low-resolution intent vectors before reaching central pools.</div>
            </div>
            <div className="rsp-principle-card">
              <div className="rsp-pc-icon"><IconFlame /></div>
              <div className="rsp-pc-title">2. Burn-on-Write Safeguard</div>
              <div className="rsp-pc-body">All PII, exact IP addresses, and high-precision GPS coordinates for Tier 4 critical data are irreversibly destroyed at the edge.</div>
            </div>
            <div className="rsp-principle-card">
              <div className="rsp-pc-icon"><IconShield /></div>
              <div className="rsp-pc-title">3. k-Anonymity Density Threshold</div>
              <div className="rsp-pc-body">Regional telemetry is held in escrow until minimum population threshold (N ≥ 50) is achieved to guarantee zero individual traceability.</div>
            </div>
            <div className="rsp-principle-card">
              <div className="rsp-pc-icon"><IconSync /></div>
              <div className="rsp-pc-title">4. Crisis Commercial Suppression</div>
              <div className="rsp-pc-body">Hard-coded protocol override automatically suppresses commercial messaging, ads, and monetization signals whenever regional strain exceeds threshold.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="rsp-section" id="pulse-strain">
        <div className="rsp-section-header">
          <div className="rsp-eyebrow">Mathematical Formulation</div>
          <h2 className="rsp-h2">The Event Strain Index (ESI)</h2>
          <p className="rsp-lead">
            Real-time mathematical model calculating regional capacity vs demand equilibrium across RSP nodes.
          </p>
        </div>
        ...
        >
          ...
          >
            ESI = ( V<sub>current</sub> / V<sub>baseline</sub> ) × ( 1 + S<sub>urgency</sub> / C<sub>capacity</sub> )
          </div>
        </div>

        <div className="rsp-principle-grid">
          <div className="rsp-principle-card">
            <div className="rsp-pc-title" style={{ fontFamily: "monospace", color: "var(--rsp-primary)" }}>
              V<sub>current</sub> / V<sub>baseline</sub>
            </div>
            <div className="rsp-pc-body">
              Ratio of current 15-minute sliding window telemetry event volume (V<sub>current</sub>) to the 30-day trailing regional baseline (V<sub>baseline</sub>).
            </div>
          </div>
          <div className="rsp-principle-card">
            <div className="rsp-pc-title" style={{ fontFamily: "monospace", color: "var(--rsp-primary)" }}>
              S<sub>urgency</sub> / C<sub>capacity</sub>
            </div>
            <div className="rsp-pc-body">
              Weighted crisis severity factor (S<sub>urgency</sub>) relative to available responder bandwidth and volunteer helper density (C<sub>capacity</sub>).
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="rsp-section-header">
            ...
            <h2 className="rsp-h2">Disaster & Humanitarian Aid Framework</h2>
            <p className="rsp-lead">
              Real-time population strain sensing integrated across the 5 stages of care and emergency coordination.
            </p>
          </div>
          ...
          <div className="rsp-principle-grid">
            <div className="rsp-principle-card">
              ...
              <div className="rsp-pc-body">Quick first aid guidance, readiness checklists, and pre-event capacity sensing.</div>
            </div>
            <div className="rsp-principle-card">
              <div className="rsp-pc-icon"><IconFlame /></div>
              <div
              ...
              <div className="rsp-pc-body">Active emergency guidance, real-time crisis routing, and rapid ESI strain telemetry.</div>
            </div>
            <div className="rsp-principle-card">
              <div className="rsp-pc-icon"><IconSync /></div>
              <div
              ...
              <div className="rsp-pc-body">Post-disaster resource matching, food/shelter coordination, and burn-on-write privacy.</div>
            </div>
            <div className="rsp-principle-card">
              <div className="rsp-pc-icon"><IconHeart /></div>
              <div
              ...
              <div className="rsp-pc-body">Mental health & emotional support without psychological profiling or surveillance records.</div>
            </div>
          </div>
        </div>
      </section>
