...
grant select, insert, update, delete on public.hub_moments to authenticated;
grant all on public.hub_moments to service_role;
...
grant select, insert, update, delete on public.rsp_validation_events to authenticated;
grant all on public.rsp_validation_events to service_role;
...
create policy "Family members can read hub moments"
  on public.hub_moments for select to authenticated
  using (public.is_family_member(family_id, auth.uid()));

create policy "Family members can create hub moments"
  on public.hub_moments for insert to authenticated
...
create policy "Family members can update their hub moments"
  on public.hub_moments for update to authenticated
...
create policy "Family members can read validation events"
  on public.rsp_validation_events for select to authenticated
  using (public.is_family_member(family_id, auth.uid()));
